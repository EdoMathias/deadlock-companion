...
import {
  MonitorInfo,
  MonitorsService,
} from '../services/windows-odk/monitors.service';
...
export class WindowsController {
  ...
  //     dockTo?: Edge,
  //   ): Promise<void> {
  //     await this._windowsService.showRotationIngameWindow(
  //       centerOnMonitor,
  //       dockTo,
  //     );
  //   }
  ...
  //   public async setRotationIngameWindowSize(
  //     width: number,
  //     height: number,
  //   ): Promise<void> {
  ...
  public async showCompanionAppReadyWindow(
    ...
    await this._windowsService.showCompanionAppReadyWindow(
      centerOnMonitor,
      dockTo,
    );
  }
