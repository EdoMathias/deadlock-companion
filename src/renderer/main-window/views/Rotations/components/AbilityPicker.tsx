...
const AbilityPicker: React.FC<AbilityPickerProps> = ({
  squad,
  anchorEl,
  onSelect,
  onClose,
  ...
  const hoveredCharacter =
    squad.find((c) => c.id === hoveredCharacterId) ?? null;
  ...
  return createPortal(
    <div
      ...
      style={{
        ...
        right:
          placement === 'left' ? window.innerWidth - position.left : undefined,
      }}
    >
      {/* Left panel: Character list */}
      <div className="ability-picker-characters">
        <div className="ability-picker-panel-header">Select Character</div>
      ...
      {hoveredCharacter && (
        <div className="ability-picker-actions">
          <div className="ability-picker-panel-header">Select Action</div>
